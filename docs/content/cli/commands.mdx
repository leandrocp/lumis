...
| `--pre-attr <name=value>` | | Attribute for the wrapping `<pre>` tag, repeat for more than one |
| `--code-attr <name=value>` | | Attribute for the nested `<code>` tag, repeat for more than one |
