...
| Runtime | Options |
| --- | --- |
| Rust | `language`, `theme`, `pre_class`, `italic`, `include_highlights`, `rainbow_brackets`, `highlight_lines`, `line_numbers`, `header` |
| Elixir | `language`, `theme`, `pre_class`, `italic`, `include_highlights`, `rainbow_brackets`, `highlight_lines`, `line_numbers`, `header` |
| JavaScript | `language`, `theme`, `preClass`, `italic`, `includeHighlights`, `rainbowBrackets`, `highlightLines`, `lineNumbers`, `header` |
| Java | `withLang()`, `withTheme()`, `withFormatter(Formatter.HTML_INLINE)` |
| CLI | `--theme`, `--pre-class`, `--italic`, `--include-highlights`, `--rainbow-brackets`, `--highlight-lines`, `--highlight-lines-class`, `--highlight-lines-style`, `--line-numbers`, `--line-numbers-start`, `--header-open`, `--header-close` |
