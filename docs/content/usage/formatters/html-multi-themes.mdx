...
| Runtime | Options |
| --- | --- |
| Rust | `language`, `themes`, `default_theme`, `css_variable_prefix`, `pre_class`, `italic`, `include_highlights`, `rainbow_brackets`, `highlight_lines`, `line_numbers`, `header` |
| Elixir | `language`, `themes`, `default_theme`, `css_variable_prefix`, `pre_class`, `italic`, `include_highlights`, `rainbow_brackets`, `highlight_lines`, `line_numbers`, `header` |
| JavaScript | `language`, `themes`, `defaultTheme`, `cssVariablePrefix`, `preClass`, `italic`, `includeHighlights`, `rainbowBrackets`, `highlightLines`, `lineNumbers`, `header` |
| Java | Not currently supported in `lumis4j` |
| CLI | `--themes`, `--default-theme`, `--css-variable-prefix`, `--pre-class`, `--italic`, `--include-highlights`, `--rainbow-brackets`, `--highlight-lines`, `--highlight-lines-class`, `--highlight-lines-style`, `--line-numbers`, `--line-numbers-start`, `--header-open`, `--header-close` |
