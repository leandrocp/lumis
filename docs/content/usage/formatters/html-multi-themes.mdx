...
| CLI | `--themes`, `--default-theme`, `--css-variable-prefix`, `--pre-class`, `--pre-attr`, `--code-attr`, `--italic`, `--include-highlights`, `--rainbow-brackets`, `--highlight-lines`, `--highlight-lines-class`, `--highlight-lines-style`, `--line-numbers`, `--header-open`, `--header-close` |
