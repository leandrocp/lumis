...
| Runtime | Options |
| --- | --- |
| Rust | `language`, `pre_class`, `rainbow_brackets`, `highlight_lines`, `line_numbers`, `header` |
| Elixir | `language`, `pre_class`, `rainbow_brackets`, `highlight_lines`, `line_numbers`, `header` |
| JavaScript | `language`, `preClass`, `rainbowBrackets`, `highlightLines`, `lineNumbers`, `header` |
| Java | `withLang()`, `withFormatter(Formatter.HTML_LINKED)` |
| CLI | `--pre-class`, `--rainbow-brackets`, `--highlight-lines`, `--highlight-lines-class`, `--line-numbers`, `--line-numbers-start`, `--header-open`, `--header-close` |
