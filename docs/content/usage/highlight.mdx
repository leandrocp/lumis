...
| Bound query matches | `--match-limit` | `.match_limit(...)` | `match_limit: ...` | `matchLimit: ...` | — |
| Bound render time | `--time-limit` | `.time_limit(...)` | `time_limit: ...` | `timeLimit: ...` | — |

Both limits are one feature; see [Budget](/advanced/budget) for what happens
