...
demand. `lumis languages download` moves that download and compilation ahead of the
...
- `lumis languages download ...` persists selected parsers, `--all` takes every one
- `lumis languages download ... --force` resolves the compatible package range again
