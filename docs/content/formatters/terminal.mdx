...
| Runtime | Options |
| --- | --- |
| Rust | `language`, `theme`, `background`, `width`, `highlight_lines`, `line_numbers` |
| Elixir | `language`, `theme`, `background`, `width`, `highlight_lines`, `line_numbers` |
| JavaScript / TypeScript | `language`, `theme`, `background`, `width`, `highlightLines`, `lineNumbers` |
| Java | `withLang()`, `withTheme()`, `withFormatter(Formatter.TERMINAL)` |
| CLI | default formatter, `--theme`, `--background`, `--width`, `--highlight-lines`, `--highlight-lines-background`, `--line-numbers` |
