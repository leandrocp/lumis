...
| JavaScript / TypeScript | `language`, `themes`, `defaultTheme`, `cssVariablePrefix`, `preClass`, `preAttrs`, `codeAttrs`, `italic`, `includeHighlights`, `rainbowBrackets`, `highlightLines`, `lineNumbers`, `header` |
