...
Set the production domain to `docs.lumis.sh`, then create the DNS record Vercel requests in Cloudflare. Keep `lumis.sh` on GitHub Pages; `.github/workflows/deploy-website.yml` builds only the website.
