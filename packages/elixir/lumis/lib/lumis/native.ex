...
defmodule Lumis.Native do
  ...
  def lock_remove(_path, _languages), do: :erlang.nif_error(:nif_not_loaded)
  def lock_update(_path, _languages, _all), do: :erlang.nif_error(:nif_not_loaded)
  def lock_languages(_path), do: :erlang.nif_error(:nif_not_loaded)
