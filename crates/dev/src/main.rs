...
fn gen_samples_entries(
    ...
    for theme in themes {
        let theme = lumis::themes::get(theme).expect("Failed to get theme");
        ...
        for entry in entries {
            ...
            let lang = lumis::languages::Language::guess(Some(file_name), &contents);
            ...
            let highlighted = lumis::highlight(&contents, formatter);
